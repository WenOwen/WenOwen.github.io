...
import { identity, awards } from '../../../../content/site.config.js';
...
// Copy comes from `identity` (and `awards`) in src/content/site.config.js
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: identity.aboutTitle, subtitle: identity.aboutSubtitle },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'AWARDS', subtitle: awards.slice(0, 2).map(a => a.title).join(' • ') },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: identity.bio },
