...
import { useStudioContent } from '../../../../hooks/useContent';
...
const StudioRoom = ({ showRoom, onReady, isExiting, isWarmup }) => {
    ...
    const configContent = useStudioContent();
    const activeContent = configContent || CONTENT_DATA;
...
const MonitorBlock = memo(({ item, meshRef, isSelected, onMonitorClick, disabled, paintOnBeforeCompile, paintUniforms }) => {
    ...
    // Check device types (prioritize the content item's 'device' field, fallback to platform defaults)
