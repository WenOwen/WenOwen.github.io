...
import { useGalleryProjects, useStudioContent, useAwards } from '../../hooks/useContent';
    ...
    return (
        <div className="sr-overlay" role="complementary" aria-label="Accessible navigation for 3D portfolio">
            ...
            <nav id="sr-main-nav" className="sr-only" aria-label="Portfolio rooms">
                <h1>{identity.name} ({identity.handle}) — Creative Developer Portfolio</h1>
                <h2>Portfolio Navigation</h2>

                {!hasEntered && (
                    <p>Welcome to {identity.name}'s interactive 3D portfolio — {identity.bio}. Click or press Enter on the doors to enter.</p>
                )}
